...
function App() {
  ...
  return (
    ...
    <div>
      Mortgage Calulation Result
    </div>
    <div className='item-container'>
      <div className='card'>   
            <div>Ratio between mortgage and down payment {mortgageCalculation.difference_ratio}</div>
            <div> Mortgage amount before adding CHMC Insurance, it applies for high ratio loans {mortgageCalculation.mortgage_before_chmc}</div>
            <div>Chmc Insurance Total Amount{mortgageCalculation.chmc_insurance_total}</div>
            <div>Payment per payment amount {mortgageCalculation.mortgage_payment_schedule}</div>
            <div>Mortgage Total {mortgageCalculation.mortgage_total}</div>
          </div>
      </div>
